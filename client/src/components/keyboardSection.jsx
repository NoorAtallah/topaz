...
const Keyboard = ({ pressedKeys }) => {
    ...
    return (
        <div className="mx-auto h-fit w-fit rounded-xl bg-gradient-to-b from-zinc-800 to-black p-2 shadow-2xl shadow-[#8C5695]/20 transition-all duration-500 ease-out" style={{ transform: 'scale(1.7) rotateX(12deg)', transformOrigin: 'top center' }}>
            {/* --- Row 1: Function Keys --- */}
        ...
        <>
            <style>{`
                @keyframes smoothBreathing {
                    0%, 100% {
                        box-shadow: 0 0 4px 2px #8C5695, 0 0 12px #8C5695, 0 0 20px rgba(140, 86, 149, 0.3);
                        transform: translateY(-1px) scale(1.02);
                    }
                    50% {
                        box-shadow: 0 0 8px 3px #8C5695, 0 0 24px #8C5695, 0 0 36px rgba(140, 86, 149, 0.6);
