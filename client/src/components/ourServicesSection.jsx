...
const ServicesSection = () => {
  return (
    <div className="container min-h-svh place-content-center bg-gradient-to-b from-purple-50/30 via-white to-purple-50/30 px-6 py-24 text-gray-900 xl:px-12">
      <div className="grid md:grid-cols-2 md:gap-8 xl:gap-12">
        ...
        <div className="left-0 top-0 md:sticky md:h-svh md:py-12">
          ...
          <h2 className="mb-6 mt-4 text-4xl font-black tracking-tight md:text-5xl lg:text-6xl">
          ...
          {SERVICES.map((service, index) => {
            ...
            return (
              <CardSticky
                ...
                incrementY={40}
                incrementZ={10}
                className="rounded-3xl border border-white/20 bg-white/40 p-8 shadow-2xl backdrop-blur-xl transition-all hover:shadow-[0_20px_60px_-15px_rgba(140,86,149,0.4)] hover:bg-white/60 md:p-10"
              >
                {/* Icon */}
                <motion.div
                  whileHover={{ scale: 1.1, rotate: 5 }}
                  className="mb-6 inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-[#8C5695] to-[#986AA1] text-white shadow-lg backdrop-blur-sm"
                >
                ...
                <div className="flex items-center justify-between border-t border-gray-100 pt-6">
                  <motion.div
                    ...
                    className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-[#8C5695] to-[#986AA1] px-6 py-3 text-sm font-bold text-white shadow-lg"
                  >
...
<Link href="/services" passHref>
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    className="flex items-center gap-2 text-sm font-bold text-[#8C5695] transition-colors hover:text-[#986AA1]"
                  >
                    Learn More
