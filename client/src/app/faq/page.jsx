        ...
        >
          ...
          >
            <div className="group relative">
              <div className="absolute -inset-1 rounded-2xl bg-gradient-to-r from-[#8C5695] to-[#986AA1] opacity-30 blur transition-opacity group-focus-within:opacity-60" />
              <div className="relative flex items-center gap-3 rounded-2xl border border-[#8C5695]/40 bg-black/50 px-6 py-4 backdrop-blur-xl">
  ...
  return (
    ...
    >
      <div
        ...
        style={{ background: `linear-gradient(135deg, ${faq.color}, transparent)` }}
      />

      <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-black/90 to-black/70 backdrop-blur-xl">
        {/* Question Button */}
        <motion.button
          onClick={onClick}
        ...
        <AnimatePresence>
          {isOpen && (
            ...
            >
              <div className="border-t border-white/5 p-6 pl-20">
  ...
  return (
    ...
    >
      <div className="mb-6 inline-flex">
        <div className="relative">
          <div className="absolute inset-0 rounded-full bg-[#8C5695] opacity-30 blur-2xl" />
          <div className="relative flex h-20 w-20 items-center justify-center rounded-full border-2 border-[#8C5695]/50 bg-gradient-to-br from-[#8C5695]/20 to-[#986AA1]/20">
    ...
    <section className="relative px-4 py-24 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-4xl">
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.8 }}
          className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-[#8C5695]/10 to-[#986AA1]/5 p-12 text-center backdrop-blur-xl"
        >
